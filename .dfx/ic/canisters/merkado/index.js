...
import { idlFactory } from './merkado.did.js';
export { idlFactory } from './merkado.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MERKADO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./merkado.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the merkado canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./merkado.did.js")._SERVICE>}
 */
export const merkado = createActor(canisterId);
