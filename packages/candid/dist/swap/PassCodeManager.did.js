export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        destoryPasscode: IDL.Func([IDL.Principal, IDL.Principal, IDL.Nat], [Result_1], []),
        ...
        requestPasscode: IDL.Func([IDL.Principal, IDL.Principal, IDL.Nat], [Result_1], []),
        withdraw: IDL.Func([WithdrawArgs], [Result], []),
    });
};
//# sourceMappingURL=PassCodeManager.did.js.map