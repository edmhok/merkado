export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        get_blocks: IDL.Func([IDL.Record({ start: IDL.Nat, length: IDL.Nat })], [IDL.Record({ blocks: IDL.Vec(Block) })], ["query"]),
        get_transaction: IDL.Func([IDL.Nat64], [IDL.Opt(Transaction)], ["query"]),
        get_transactions: IDL.Func([IDL.Record({ start: IDL.Nat, length: IDL.Nat })], [IDL.Record({ transactions: IDL.Vec(Transaction) })], ["query"]),
        remaining_capacity: IDL.Func([], [IDL.Nat64], ["query"])
    });
};
//# sourceMappingURL=icrc.archive.did.js.map