export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        get_auto_finalization_status: IDL.Func([IDL.Record({})], [GetAutoFinalizationStatusResponse], ["query"]),
        ...
        list_community_fund_participants: IDL.Func([ListCommunityFundParticipantsRequest], [NeuronsFundParticipants], ["query"]),
        list_direct_participants: IDL.Func([ListDirectParticipantsRequest], [ListDirectParticipantsResponse], ["query"]),
        list_sns_neuron_recipes: IDL.Func([ListSnsNeuronRecipesRequest], [ListSnsNeuronRecipesResponse], ["query"]),
        ...
        restore_dapp_controllers: IDL.Func([IDL.Record({})], [SetDappControllersCallResult], []),
    });
};
...
//# sourceMappingURL=swap.did.js.map