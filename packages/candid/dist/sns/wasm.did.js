export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        get_deployed_sns_by_proposal_id: IDL.Func([GetDeployedSnsByProposalIdRequest], [GetDeployedSnsByProposalIdResponse], ["query"]),
        get_latest_sns_version_pretty: IDL.Func([IDL.Null], [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Text))], ["query"]),
        ...
        insert_upgrade_path_entries: IDL.Func([InsertUpgradePathEntriesRequest], [InsertUpgradePathEntriesResponse], []),
        ...
        update_allowed_principals: IDL.Func([UpdateAllowedPrincipalsRequest], [UpdateAllowedPrincipalsResponse], []),
        update_sns_subnet_list: IDL.Func([UpdateSnsSubnetListRequest], [UpdateSnsSubnetListResponse], []),
    });
};
//# sourceMappingURL=wasm.did.js.map