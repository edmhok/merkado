export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        getAddressAndCountByCondition: IDL.Func([IDL.Text, IDL.Text, IDL.Nat, IDL.Nat, IDL.Nat], [IDL.Vec(IDL.Record({ count: IDL.Nat, address: IDL.Text }))], ["query"]),
        getAdminList: IDL.Func([], [IDL.Vec(IDL.Text)], []),
        getAllTransactions: IDL.Func([IDL.Text, IDL.Text, IDL.Int, IDL.Opt(TransactionType), IDL.Nat, IDL.Nat], [Page], ["query"]),
...
//# sourceMappingURL=BaseDataStructure.did.js.map