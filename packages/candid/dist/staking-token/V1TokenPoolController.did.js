export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        createIncentive: IDL.Func([IncentiveKey, IDL.Nat], [ResponseResult_2], []),
        ...
        findIncentivesPoolsList: IDL.Func([IDL.Nat, IDL.Nat], [ResponseResult_1], ["query"]),
        findUserCreateIncentives: IDL.Func([User, IDL.Nat, IDL.Nat], [ResponseResult_1], []),
        getAdminList: IDL.Func([], [IDL.Vec(IDL.Text)], []),
        getErrorMsg: IDL.Func([], [IDL.Text], ["query"]),
        ...
        setMaxIncentiveDuration: IDL.Func([IDL.Nat], [], ["oneway"]),
        setMaxIncentiveStartLeadTime: IDL.Func([IDL.Nat], [], ["oneway"]),
...
//# sourceMappingURL=V1TokenPoolController.did.js.map