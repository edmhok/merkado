...
export interface VoteProjectCanister {
  ...
  findPage: ActorMethod<[[] | [string], [] | [bigint], bigint, bigint], ResponseResult_5>;
  findRecordPage: ActorMethod<[string, bigint, bigint], ResponseResult_4>;
  findVotePower: ActorMethod<[[] | [string], [] | [string], bigint, bigint], ResponseResult_3>;
...
export type _SERVICE = VoteProjectCanister;
