...
export type { _SERVICE as PoolStorage, PublicPoolOverView as PoolOverview, PublicPoolChartDayData, Transaction as PoolStorageTransaction, } from "./PoolStorage";
export { idlFactory as TokenStorageInterfaceFactory } from "./TokenStorage.did";
export type { _SERVICE as TokenStorage, PublicTokenOverview as InfoToken, PublicTokenChartDayData, Transaction as InfoTokenTransaction, PublicTokenPricesData, PoolInfo as TokenPoolsInfo, } from "./TokenStorage";
