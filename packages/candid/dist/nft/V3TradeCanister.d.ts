...
export type ResponseResult = {
    'ok': [boolean, bigint, bigint, bigint];
} | {
    'err': string;
};
...
export interface _SERVICE {
    ...
    'findCanisterRecommend': (arg_0: string, arg_1: bigint, arg_2: bigint) => Promise<ResponseResult_5>;
    'findOrderPage': (arg_0: [] | [string], arg_1: [] | [string], arg_2: [] | [AccountIdentifier__1], arg_3: [] | [TokenIndex], arg_4: bigint, arg_5: bigint, arg_6: string, arg_7: boolean) => Promise<ResponseResult_5>;
    'findRecommend': (arg_0: bigint, arg_1: bigint) => Promise<ResponseResult_5>;
    'findTokenOrderPage': (arg_0: TokenIndex, arg_1: string, arg_2: bigint, arg_3: bigint, arg_4: string, arg_5: boolean) => Promise<ResponseResult_5>;
    'findTokenTxPage': (arg_0: TokenIndex, arg_1: string, arg_2: bigint, arg_3: bigint, arg_4: string, arg_5: boolean) => Promise<ResponseResult_4>;
    'findTxPage': (arg_0: [] | [string], arg_1: [] | [string], arg_2: [] | [TokenIndex], arg_3: bigint, arg_4: bigint, arg_5: string, arg_6: boolean) => Promise<ResponseResult_4>;
    'findUserTxPage': (arg_0: AccountIdentifier__1, arg_1: [] | [string], arg_2: [] | [string], arg_3: bigint, arg_4: bigint, arg_5: string, arg_6: boolean) => Promise<ResponseResult_4>;
    ...
    'setCanisterId': (arg_0: [] | [string], arg_1: [] | [string], arg_2: [] | [string]) => Promise<BoolResult>;
    'setState': (arg_0: string, arg_1: string, arg_2: string) => Promise<BoolResult>;
    'setTradeState': (arg_0: boolean) => Promise<BoolResult>;
    'unlock': (arg_0: string, arg_1: TokenIndex) => Promise<BoolResult>;
}
//# sourceMappingURL=V3TradeCanister.d.ts.map