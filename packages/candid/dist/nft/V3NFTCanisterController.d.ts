...
export type ResponseResult = {
    'ok': [bigint, bigint, string, string];
} | {
    'err': string;
};
...
export type ResponseResult_4 = {
    'ok': [bigint, string, string, string];
} | {
    'err': string;
};
...
export interface _SERVICE {
    ...
    'setCanisterConfig': (arg_0: bigint, arg_1: [] | [string], arg_2: [] | [string], arg_3: [] | [string], arg_4: number) => Promise<BoolResult>;
...
//# sourceMappingURL=V3NFTCanisterController.d.ts.map