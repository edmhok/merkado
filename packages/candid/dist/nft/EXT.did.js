export const idlFactory = ({ IDL }) => {
    ...
    const MetadataValue = IDL.Tuple(IDL.Text, IDL.Variant({
        nat: IDL.Nat,
    ...
    return IDL.Service({
        ...
        adminRefund: IDL.Func([IDL.Text, AccountIdentifier__1, AccountIdentifier__1], [IDL.Text], []),
        adminStartHeartbeat: IDL.Func([], [], []),
        allSettlements: IDL.Func([], [
            IDL.Vec(IDL.Tuple(TokenIndex, IDL.Record({
                subaccount: SubAccount__1,
                seller: IDL.Principal,
                buyer: AccountIdentifier__1,
                price: IDL.Nat64,
        ...
        ext_marketplaceListings: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, Listing, Metadata))], ["query"]),
        ext_marketplacePurchase: IDL.Func([TokenIdentifier__1, IDL.Nat64, AccountIdentifier__1], [Result_9], []),
        ext_marketplaceSettle: IDL.Func([AccountIdentifier__1], [Result_3], []),
        ext_marketplaceStats: IDL.Func([], [IDL.Nat64, IDL.Nat64, IDL.Nat64, IDL.Nat64, IDL.Nat, IDL.Nat, IDL.Nat], ["query"]),
        ext_marketplaceTransactions: IDL.Func([], [IDL.Vec(Transaction)], ["query"]),
        ext_metadata: IDL.Func([TokenIdentifier__1], [Result_8], ["query"]),
        ext_mint: IDL.Func([IDL.Vec(IDL.Tuple(AccountIdentifier__1, Metadata))], [IDL.Vec(TokenIndex)], []),
        ...
        ext_saleOpen: IDL.Func([IDL.Vec(SalePricingGroup), SaleRemaining, IDL.Vec(AccountIdentifier__1)], [IDL.Bool], []),
        ext_salePause: IDL.Func([], [IDL.Bool], []),
        ext_salePurchase: IDL.Func([IDL.Nat, IDL.Nat64, IDL.Nat64, AccountIdentifier__1], [Result_5], []),
...
//# sourceMappingURL=EXT.did.js.map