export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        setCanisterConfig: IDL.Func([IDL.Nat, IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Nat32], [BoolResult], []),
        setFeeInfo: IDL.Func([IDL.Nat, IDL.Nat, IDL.Text, IDL.Text], [ResponseResult], []),
        setLogo: IDL.Func([IDL.Text, IDL.Text], [BoolResult], [])
    });
};
//# sourceMappingURL=V3NFTCanisterController.did.js.map