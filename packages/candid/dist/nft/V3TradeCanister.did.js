export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        findOrderPage: IDL.Func([
            ...
            IDL.Text,
            IDL.Bool
        ], [ResponseResult_5], ["query"]),
        findRecommend: IDL.Func([IDL.Nat, IDL.Nat], [ResponseResult_5], ["query"]),
        findTokenOrderPage: IDL.Func([TokenIndex, IDL.Text, IDL.Nat, IDL.Nat, IDL.Text, IDL.Bool], [ResponseResult_5], ["query"]),
        findTokenTxPage: IDL.Func([TokenIndex, IDL.Text, IDL.Nat, IDL.Nat, IDL.Text, IDL.Bool], [ResponseResult_4], ["query"]),
        findTxPage: IDL.Func([IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Opt(TokenIndex), IDL.Nat, IDL.Nat, IDL.Text, IDL.Bool], [ResponseResult_4], ["query"]),
        findUserTxPage: IDL.Func([AccountIdentifier__1, IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Nat, IDL.Nat, IDL.Text, IDL.Bool], [ResponseResult_4], ["query"]),
...
//# sourceMappingURL=V3TradeCanister.did.js.map