export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        'findCanisterStat': IDL.Func([IDL.Nat, IDL.Nat], [ResponseResult_3], ['query']),
        'findNameStat': IDL.Func([IDL.Text, IDL.Nat, IDL.Nat], [ResponseResult_3], ['query']),
        ...
        'listStat': IDL.Func([IDL.Text, IDL.Text, IDL.Nat, IDL.Bool], [BoolResult], []),
        ...
        'tradeStat': IDL.Func([IDL.Nat, IDL.Nat, IDL.Text, IDL.Text], [BoolResult], []),
    });
};
export const init = ({ IDL }) => { return []; };
//# sourceMappingURL=V3TradeStat.did.js.map