...
export interface _SERVICE {
  ...
  get_most_recent_monthly_node_provider_rewards: ActorMethod<[], [] | [MostRecentMonthlyNodeProviderRewards]>;
  ...
  get_neuron_info_by_id_or_subaccount: ActorMethod<[NeuronIdOrSubaccount], Result_4>;
