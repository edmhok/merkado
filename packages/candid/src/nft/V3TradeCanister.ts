...
export type ResponseResult = { ok: [boolean, bigint, bigint, bigint] } | { err: string };
export type ResponseResult_1 = { ok: StatResponse } | { err: string };
export type ResponseResult_2 = { ok: OrderInfo } | { err: string };
...
export type ResponseResult_6 = { ok: [string, string] } | { err: string };
