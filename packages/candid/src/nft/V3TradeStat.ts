...
export type ResponseResult = { ok: StatResponse } | { err: string };
export type ResponseResult_1 = { ok: TradeStatResp } | { err: string };
export type ResponseResult_2 = { ok: Array<string> } | { err: string };
...
export interface _SERVICE {
  ...
  findCanisterStat: (arg_0: bigint, arg_1: bigint) => Promise<ResponseResult_3>;
  findNameStat: (arg_0: string, arg_1: bigint, arg_2: bigint) => Promise<ResponseResult_3>;
  ...
  listStat: (arg_0: string, arg_1: string, arg_2: bigint, arg_3: boolean) => Promise<BoolResult>;
  removeAdmin: (arg_0: string) => Promise<BoolResult>;
  setCanisterId: (arg_0: [] | [string], arg_1: [] | [string], arg_2: [] | [string]) => Promise<BoolResult>;
  tradeStat: (arg_0: bigint, arg_1: bigint, arg_2: string, arg_3: string) => Promise<BoolResult>;
}
