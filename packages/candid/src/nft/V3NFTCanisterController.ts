...
export type ResponseResult = { ok: [bigint, bigint, string, string] } | { err: string };
export type ResponseResult_1 = { ok: Array<string> } | { err: string };
export type ResponseResult_2 = { ok: PageResponse } | { err: string };
export type ResponseResult_3 = { ok: Page } | { err: string };
export type ResponseResult_4 = { ok: [bigint, string, string, string] } | { err: string };
export type ResponseResult_5 = { ok: CanisterInfo } | { err: string };
...
export interface _SERVICE {
  ...
  findTop5Canister: (arg_0: bigint, arg_1: bigint) => Promise<ResponseResult_3>;
  findUserCanister: (arg_0: string, arg_1: bigint, arg_2: bigint) => Promise<ResponseResult_2>;
  ...
  setFeeInfo: (arg_0: bigint, arg_1: bigint, arg_2: string, arg_3: string) => Promise<ResponseResult>;
