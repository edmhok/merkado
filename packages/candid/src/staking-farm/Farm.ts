...
export type Result_10 = { ok: FarmInfo } | { err: Error };
export type Result_11 = { ok: Page_2 } | { err: string };
export type Result_12 = { ok: Deposit } | { err: Error };
export type Result_13 = { ok: CycleInfo } | { err: Error };
export type Result_14 = { ok: Array<Principal> } | { err: Error };
export type Result_15 =
  | {
      ok: { rewardPoolCid: string; poolCid: string };
    }
  | { err: Error };
export type Result_2 = { ok: Page } | { err: Error };
export type Result_3 =
  | {
      ok: { stakedTokenTVL: number; rewardTokenTVL: number };
    }
  | { err: Error };
export type Result_4 = { ok: Page_1 } | { err: string };
