...
export type Result_11 = { ok: [bigint, bigint] } | { err: string };
export type Result_12 = { ok: CycleInfo } | { err: Error };
export type Result_13 = { ok: CanisterInfo } | { err: string };
export type Result_14 = { ok: Page } | { err: string };
export type Result_15 = { ok: Page_1 } | { err: string };
export type Result_16 = { ok: string } | { err: CommonError };
export type Result_17 = { ok: bigint } | { err: CommonError };
export type Result_2 = { ok: Balance } | { err: CommonError };
export type Result_3 = { ok: boolean } | { err: string };
export type Result_4 = { ok: QueryPositionResult } | { err: string };
export type Result_5 = { ok: Balance } | { err: string };
export type Result_6 = { ok: TokenIndex } | { err: string };
export type Result_7 = { ok: Metadata } | { err: CommonError };
export type Result_8 = { ok: bigint } | { err: string };
export type Result_9 = { ok: TokenMetadata } | { err: string };
...
export interface SwapNFT {
  ...
  getAllowances: ActorMethod<[], Array<[TokenIndex, Array<AccountIdentifier>]>>;
  ...
  initNFTCanisterInfo: ActorMethod<[CanisterInfo, TokenIndex, string], Result_1>;
