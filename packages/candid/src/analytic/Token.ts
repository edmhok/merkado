...
export interface _SERVICE {
  ...
  getTokenChartData: ActorMethod<[string, bigint, bigint], Array<PublicTokenChartDayData>>;
  getTokenPricesData: ActorMethod<[string, bigint, bigint, bigint], Array<PublicTokenPricesData>>;
  getTokenTransactions: ActorMethod<[string, bigint, bigint], Array<TransactionsType>>;
