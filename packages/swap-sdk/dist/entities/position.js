...
import { MaxUint256, Percent, CurrencyAmount } from "../core";
...
export class Position {
    ...
    mintAmountsWithSlippage(slippageTolerance) {
        ...
        const poolLower = new Pool(this.pool.id, this.pool.token0, this.pool.token1, this.pool.fee, sqrtRatioX96Lower, 0 /* liquidity doesn't matter */, TickMath.getTickAtSqrtRatio(sqrtRatioX96Lower));
        const poolUpper = new Pool(this.pool.id, this.pool.token0, this.pool.token1, this.pool.fee, sqrtRatioX96Upper, 0 /* liquidity doesn't matter */, TickMath.getTickAtSqrtRatio(sqrtRatioX96Upper));
