...
describe("Route", () => {
    ...
    describe("#midPrice", () => {
        const pool_0_1 = new Pool("xxxxxxxx", token0, token1, FeeAmount.MEDIUM, encodeSqrtRatioX96(1, 5), 0, TickMath.getTickAtSqrtRatio(encodeSqrtRatioX96(1, 5)), []);
        const pool_1_2 = new Pool("xxxxxxxx", token1, token2, FeeAmount.MEDIUM, encodeSqrtRatioX96(15, 30), 0, TickMath.getTickAtSqrtRatio(encodeSqrtRatioX96(15, 30)), []);
        it("correct for 0 -> 1", () => {
